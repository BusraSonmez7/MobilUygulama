...
public class OkunanKitaplar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_okunan_kitaplar);
        ...
        getSupportActionBar().setTitle("OKUNAN KİTAPLAR");

        veritabani = new Veritabani(this);
        this.kitaplararray = veritabani.OkunanOkunacakKitaplariListele(1);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent2 = new Intent(OkunanKitaplar.this,KitapOzellikleriActivity.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.profil:
                intent = new Intent(OkunanKitaplar.this,ProfilActivity.class);
                startActivity(intent);
                return true;
            case R.id.sil:

                AlertDialog.Builder alert;
                alert= new AlertDialog.Builder(OkunanKitaplar.this);
                ...
                alert.setPositiveButton("Evet", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        veritabani.OkunanOkunacakKitaplariSil(1);
                        Intent intent = new Intent(OkunanKitaplar.this,OkunanKitaplar.class);
                ...
                return true;
            case R.id.anasayfa:
                intent = new Intent(OkunanKitaplar.this,Anasayfa.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                return true;
            case R.id.cikis:
